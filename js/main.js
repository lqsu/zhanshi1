...
const projects = [
  { id: "project01", title: "网站01", url: "#", images: ["1.webp", "2.webp", "3.webp", "4.webp", "5.webp", "6.webp"] },
...
function getProjectIntro(project) {
  ...
  return `包含 ${count} 张页面截图，可用于展示网站首页、内页、产品页或移动端效果。`;
}
...
projects.forEach((project, index) => {
  ...
  card.innerHTML = `
    ...
    <div class="card-body">
      <div class="card-meta">Website Case</div>
